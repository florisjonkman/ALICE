...
void HFPtSpectrum ( Int_t decayChan=kLcK0Sp,
		    const char *mcfilename="D0DplusDstarPredictions_13TeV_y05_all_300416_BDShapeCorrected.root", // FONLL prediction (dσ/dydpt)_{FeedDown}^{FONLL}
		    ...
		    const char *nevhistoname="", // Not needed, we use nevents
		    const char *outfilename="OutputHFPtSpectrum_PfCutsTMVA_FixSigma_1_999.root",
		    Int_t fdMethod=kNb,
		    ...
		    Int_t analysisSpeciality=kBDT, // kTopological
